	...
	<footer id="footer">
		<div class="container">
			<div class="social text-center">
				...
				<a href="https://www.instagram.com/_shwethas_/"><i class="fa fa-instagram"></i></a>
				<a href="https://github.com/sarmithavd"><i class="fa fa-github"></i></a>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 panel">
						<div class="panel-body">
							<p class="text-right">
								Copyright &copy; VDS & SSK <a href="#" rel="develop">VDS & SSK</a>
							</p>
						</div>
					</div>
